...
public class MPGenerator {
    public static void main(String[] args) {
        ...
        //todo 要改输出路径
        globalConfig.setOutputDir(System.getProperty("user.dir") + "/fengchat-chat-server/src/main/java");
        //设置作者名字
        globalConfig.setAuthor("jiangfeng");
        ...
        packageConfig.setParent("com.feng.fengchat.common.user");//自定义包的路径
...
//        strategyConfig.setTableFillList(list);
    ...
    public static void assembleDev(DataSourceConfig dataSourceConfig) {
        ...
        dataSourceConfig.setPassword("123456@qwer");
        dataSourceConfig.setUrl("jdbc:mysql://124.70.221.38:3306/mallchat?useUnicode=true&characterEncoding=utf-8&useSSL=true&serverTimezone=UTC");
    }
}